...
export default function UniversityGpt({ navigation }) {
  ...
  const data = [
    ...
    { label: "Foreign Exchange & Pre-departure", value: "Foreign Exchange & Pre-departure",},
    { label: "Courses", value: "Courses" },
    { label: "Travel Arrangements", value: "Travel Arrangements" },
    { label: "Loans", value: "Loans" },
    { label: "Accrediations Recognization", value: "Accrediations Recognization" },
  ...
  const question2 =
    selectGpt == "University"
      ...
      : selectGpt == "University Reviews"
                          ...
                          :selectGpt=="Application Support"?"What documents are required for the application process"
      : null;
  ...
  function getFunctions(question) {
    ...
    if (userStage == "test") {
      if (selectGpt == "Loans") {
        ...
        let request = {
          url:
            BASE_URL +`student-service/user/teamD_chat?InfoType=${question}&userId=${userId}`,
          method: "post",
        };
        return request;
      }

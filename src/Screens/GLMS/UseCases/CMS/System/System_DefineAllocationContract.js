        ...
        <View style={styles.content}>
          ...
          <View style={styles.card}>
            ...
            <Section title="Actor(s)" icon={Users} sectionKey="actors">
              <View style={styles.list}>
                <Text style={styles.bullet}>
                  • Collections Admin/Supervisor (User)
                </Text>
              </View>
            </Section>
            ...
            >
              <View style={styles.list}>
                <Text style={styles.bullet}>
                  • Delinquent cases are classified.
                </Text>
                <Text style={styles.bullet}>
            ...
            <Section title="Basic Flow" icon={List} sectionKey="basicFlow">
              <View style={styles.orderedList}>
                <Text style={styles.orderedItem}>
                  1. User logs into the Collections System.
                </Text>
                <Text style={styles.orderedItem}>
                  2. User defines or modifies allocation rules for a strategy.
                </Text>
                <Text style={styles.orderedItem}>
                  3. User segregates cases based on due amount, default date,
                  and default percentage.
                </Text>
                <Text style={styles.orderedItem}>
                ...
                <View style={styles.grid}>
                  <View style={styles.column}>
                    <Text style={styles.bullet}>
                      • Strategy, Financier, Financier Type
                    </Text>
                    <Text style={styles.bullet}>
                      • Queue Code, Rule Code, Rule Unit Level & Code
                    </Text>
                    <Text style={styles.bullet}>
                ...
                <Text style={styles.orderedItem}>
                  5. User assigns delinquent cases to collectors.
                </Text>
                <Text style={styles.orderedItem}>
                  6. User saves allocation settings for future reference.
                </Text>
              </View>
            </Section>
            <Section
              title="Alternate Flow(s)"
              icon={ChevronRight}
              sectionKey="alternateFlows"
            >
            ...
            >
              ...
              <View style={styles.list}>
                ...
                <Text style={styles.bullet}>
                  ...
                  • Invalid rule definitions or missing required fields result
            ...
            >
              ...
              <View style={styles.list}>
                ...
                <Text style={styles.bullet}>
                  ...
                  • Allocation rules can only apply to strategies assigned to
                  the user's unit or child units.
                </Text>
              </View>
            </Section>
            <Section title="Assumptions" icon={Info} sectionKey="assumptions">
              ...
              <View style={styles.list}>
                ...
                <Text style={styles.bullet}>
                  ...
                  • Proper data is available for allocation (queues, rules,
                  units, etc.).
                </Text>
                <Text style={styles.bullet}>
                  • System validates rule definitions before saving.
                </Text>
              </View>
            </Section>
            <Section title="Notes" icon={Info} sectionKey="notes">
              ...
              <View style={styles.list}>
                ...
                <Text style={styles.bullet}>
                  ...
                  • This module improves control and automation of delinquent
                  case handling through structured allocation logic.
                </Text>
              </View>
            </Section>
...
const styles = StyleSheet.create({
  ...
  sectionContent: { marginTop: 8, paddingLeft: 28 },
  text: { fontSize: 16, color: "#374151", lineHeight: 24 },
  list: { marginLeft: 8 },
  bullet: { fontSize: 16, color: "#374151", lineHeight: 24, marginBottom: 4 },
  ...
  column: { flex: 1, minWidth:width*0.5, marginRight: 16 },
  flowchart: {

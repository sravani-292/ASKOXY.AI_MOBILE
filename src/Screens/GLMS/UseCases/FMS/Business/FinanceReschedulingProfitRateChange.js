      ...
      <View style={styles.mainCard}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.listContainer}>
            ...
            <View style={styles.listItem}>
              <Text style={styles.bullet}>•</Text>
              <Text style={styles.text}>Modification of Due Date Change</Text>
            </View>
          </View>
        </View>

        <View style={styles.card}>
          <Text style={styles.sectionTitle}>Modification of Rate of Interest</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.listContainer}>
            ...
            <View style={styles.listItem}>
              <Text style={styles.bullet}>•</Text>
              <Text style={styles.text}>Original Loan Amount</Text>
            </View>
            <View style={styles.listItem}>
              <Text style={styles.bullet}>•</Text>
              <Text style={styles.text}>Original Rate of Interest</Text>
            </View>
            <View style={styles.listItem}>
              <Text style={styles.bullet}>•</Text>
            ...
            <View style={styles.listItem}>
              <Text style={styles.bullet}>•</Text>
              <Text style={styles.text}>Modified Interest Rate</Text>
            </View>
            <View style={styles.listItem}>
              <Text style={styles.bullet}>•</Text>
              <Text style={styles.text}>
